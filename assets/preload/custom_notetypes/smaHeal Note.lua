function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'smaHeal Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'noteassetshit\\SHEALNOTE_assets'); --Change texture
