function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'halfHeal Note' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'noteassetshit\\HHEALNOTE_assets'); --Change texture
