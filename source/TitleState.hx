...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		add(titleBg);
		titleBg.shader = swagShader.shader;
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['ValenciaBall', 'Furret', 'and a lot of contributors']);
				...
				case 5:
					#if PSYCH_WATERMARKS
					createCoolText(['A fanmade mod', 'all about'], -40);
					#else
					createCoolText(['A fanmade mod', 'all about'], -40);
					#end
				case 7:
					addMoreText('these mods', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
